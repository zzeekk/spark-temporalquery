...
case class IntervalQueryDimension[T, D <: IntervalDef[T]](fromColName: String, toColName: String,
                                                          fromCol2Name: String, toCol2Name: String,
                                                          fromCol: Column, toCol: Column,
                                                          fromCol2: Column, toCol2: Column,
                                                          lowerHorizon: T, upperHorizon: T,
                                                          intDef: D)
