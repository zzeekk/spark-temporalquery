 ...
 */
abstract class IntervalQueryConfig[T: Ordering, D <: IntervalDef[T]] extends IntervalMultidimQueryConfig[T, D] {
  ...
  def dimensionMap: Map[String, (String, D)] = Map(fromColName -> (toColName, intervalDef))
  ...
  override val technicalColNames: List[String] = List(fromColName, toColName) ++ additionalTechnicalColNames
