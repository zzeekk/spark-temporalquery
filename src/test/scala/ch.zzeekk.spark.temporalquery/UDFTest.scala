...
class UDFTest extends org.scalatest.FunSuite {
  ...
  test("udf_temporalComplement") {
    ...
    val argExpMap = Seq(
      ("no intersection => no change", "2019-01-01 00:00:0", "2020-01-01 00:00:0", List(("2019-01-01 00:00:0", "2020-01-01 00:00:0"))),
      ("right hand intersection => interval ends earlier", "2019-01-01 00:00:0", "2020-01-01 00:00:5", List(("2019-01-01 00:00:0", "2020-01-01 00:00:0.999"))),
      ("left hand intersection => interval starts later", "2020-01-01 00:05:7", "2021-12-31 23:59:59.999", List(("2020-01-01 00:06:0.001", "2021-12-31 23:59:59.999"))),
      ("left and right hand intersection => interval starts later and ends earlier", "2020-01-01 00:02:5", "2020-01-01 00:03:5", List(("2020-01-01 00:03:0.001", "2020-01-01 00:03:2.999"))),
      ("middle intersection => interval segmented into 2 parts",
        "2019-01-01 00:00:0", "2020-01-01 00:01:9.999",
        List(("2020-01-01 00:01:0.001", "2020-01-01 00:01:9.999"), ("2019-01-01 00:00:0", "2020-01-01 00:00:0.999"))
      ),
      ("several middle intersections => interval segmented into many parts",
        "2019-01-01 00:00:0", "2021-12-31 23:59:59.999",
        List(("2020-01-01 00:06:0.001", "2021-12-31 23:59:59.999")
      ...
      ("subset => empty result", "2020-01-01 00:05:6", "2020-01-01 00:05:9", List())
    ).map { case (comment, validFrom, validTo, resultList) => ((comment, (Timestamp.valueOf(validFrom), Timestamp.valueOf(validTo))), resultList.map(y => (Timestamp.valueOf(y._1), Timestamp.valueOf(y._2)))) }
      .toMap

    testArgumentExpectedMapWithComment[(Timestamp,Timestamp), List[(Timestamp,Timestamp)]](x => temporalComplement(x._1, x._2, subtrahends))(argExpMap)
  }
